<template>
  <Transition>
    ...
    >
      <div
        class="flex flex-row flex-wrap sm:flex-nowrap justify-start px-4 sm:px-0"
      >
        ...
        <slot
          name="tableReset"
          data-can-be-read="canBeReset"
          :on-click="resetQuery"
        >
          <div v-if="canBeReset" class="order-5 sm:order-3 sm:mr-4 ml-auto">
